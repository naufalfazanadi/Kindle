...
import edu.upi.mobprogproject.model.ChatHeader;
...
public class MessageFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        RecyclerView recyclerView = (RecyclerView) v.findViewById(R.id.rcMess);
        SearchView sc = (SearchView) v.findViewById(R.id.searchView);
